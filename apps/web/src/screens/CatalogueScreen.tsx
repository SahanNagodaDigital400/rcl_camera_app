...
export function CatalogueScreen({
  ...
  /**
   * Told the query every time one is submitted, so it outlives this screen.
   *
  ...
  function submit(event: FormEvent<HTMLFormElement>): void {
    ...
    // Told to `App` on submit rather than on every keystroke: what has to
    // survive this screen being unmounted is the search that produced what is
    // on it, not a half-typed fragment.
    onSearch(query);
    load(query);
  }
