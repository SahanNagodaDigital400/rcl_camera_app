...
2. **Scanning pilot** — CAP-2 against a 150–200 Tile pilot Catalogue. Internal accuracy testing sets the top-3/top-1 accuracy targets (`SPEC.md` Success signal).
...
4. **Refinement** — accuracy improvements from real scan data, reference-image backfill for weak Tiles and weak Category folders.
